...
// 任务权限枚举
// Type 字段名
// 接受 ping / tcp_ping / http_ping / web_shell / execute / http_request / dns / read_config / edit_config / ip / version / self_update
// 支持通配符 `*`：
// - `"*"` 匹配所有任务类型
...
#[serde(rename_all = "snake_case")]
pub enum NodeGet {
    ListAllAgentUuid, // [已废弃] 列出所有 Agent Uuid，请使用 MonitoringUuid::List
